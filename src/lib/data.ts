...
export const addNewProduct = async (data: Product): Promise<AdminApiResponse> => {
    ...
    try {
        const response = await axios.post<AdminApiResponse>('/api/admin/add-product', formData, {
            headers: {
...
export const getProductData = async (id: string): Promise<ResponseProduct | undefined> => {
    try {
        const response = await axios.get<ApiResponse>(`${process.env.NEXT_PUBLIC_DOMAIN}/api/admin/update-product?id=${id}`);
...
export const updateProduct = async (id: string, data: Product): Promise<AdminApiResponse> => {
    ...
    try {
        const response = await axios.post<AdminApiResponse>('/api/admin/update-product', formData, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        });
...
export const getProducts = async () => {
    try {
        const response = await axios.get<AdminApiResponse>("/api/admin/get-products");
        ...
        return { products: products || [], message: response.data.message }
...
export const getUsers = async (): Promise<{ users: UserWithId[]; message: string }> => {
    try {
        const response = await axios.get<AdminApiResponse>("/api/admin/get-users");
...
export const getProduct = async (id: string): Promise<ResponseProduct | undefined> => {
    try {
        const response = await axios.get<ApiResponse>(`${process.env.NEXT_PUBLIC_DOMAIN}/api/product?id=${id}`);
